		...
		<div class="well well-lg">
			...
			<form role="form" class="form-horizontal" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" maxlength="50" name="genre" placeholder="Genre (referensi, fiksi, biografi, kesehatan, komputer, pendidikan, dll)" class="form-control" id="genre" required>
				</div>
...
<?php
	...
	if(isset($_POST['insertBuku'])){
		...
		$sql = "INSERT INTO buku (judul, pengarang, penerbit, thn_terbit, deskripsi_fisik, isbn, genre) VALUES ('$judul', '$pengarang', '$penerbit', '$thn_terbit', '$deskripsi_fisik', '$isbn', '$genre')";
