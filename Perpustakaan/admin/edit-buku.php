		...
		<div class="well well-lg">
			...
			<form role="form" class="form-horizontal" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" maxlength="50" name="genre" placeholder="Genre (referensi, fiksi, biografi, kesehatan, komputer, pendidikan, dll)" class="form-control" id="genre" value="<?php echo $row['genre']; ?>" required>
				</div>
