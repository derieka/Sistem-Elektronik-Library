...
<body>
	...
	<div class="container">
		<div class="well well-lg">
			...
			<p>Petunjuk :</p>
			<p>1. Klik pencarian dan masukkan kata kunci untuk mencari.</p>
			<p>2. Klik edit untuk merubah data buku.</p>
			<p>3. Klik hapus untuk menghapus buku.</p>
			</div>
		</div>
	</div>
	<div class="container">
...
<?php
	...
	if($count>0){
		...
		while($row = mysqli_fetch_assoc($result)) {
	        ...
	        $row["isbn"]."</td><td>";
					$qr='id_buku='.$row["id_buku"];

					echo '<button onclick="generateqr(\''.$qr.'\')" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalqrcode">View QRCode</button>';

					echo "<a href='edit-buku.php?id=$id' role='button' class='btn btn-primary btn-sm'>Edit</a>".
