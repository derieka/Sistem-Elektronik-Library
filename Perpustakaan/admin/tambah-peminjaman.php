			...
			<div class="well well-md">
				...
				<form role="form" class="form-horizontal" method="POST">
				  	...
				  	<div class="form-group">
						<label for="id_anggota">NIS/NIP peminjam :</label><br>
						<input type="text" maxlength="30" name="id_anggota" placeholder="NIS (untuk siswa) / NIP (untuk guru)" class="form-control" id="id_anggota" required>
					</div>
