...
<?php
	...
	if($count>0){
		...
		echo "<p class='text-info'>Ditemukan $count data buku yang cocok dengan kata kunci yang Anda masukkan<p>";
		...
		echo "Maaf, tidak ditemukan data buku yang cocok.";
